...
import { FiLock, FiPhone, FiShoppingBag, FiUser } from 'react-icons/fi'
...
function SellerSignup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/seller/register`,
                {
                ...
                <div className="w-full max-w-md bg-offwhite/95 shadow-xl rounded-lg p-6 space-y-6 z-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                <FiShoppingBag className="absolute left-3 top-4 h-4 w-4 text-warmgrey" />
                                <input
                                    type="text"
